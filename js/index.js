...
if(localStorage.getItem('token') == null){
    alert('Voc~e precisa possuir uma conta para visualizar esta página');
    window.location.href = 'login.html';
}
...
function recadosUser(){

    let userLogado = JSON.parse(localStorage.getItem('listaUser'));

    if(userLogado != null){
        let userLogado = listaLivros.push(livro)
